...
router.get('/me', auth, async (req, res) => {
    try{
        ...
        console.log('api/profile.js - ' + req.user.id);
        if(!profile){
...
router.put('/experience',[auth, [
    ...
    try{
        ...
        profile.experience.unshift(newExp); // push in newEXP to the array
        await profile.save();
...
router.put('/education',
    ...
    try{
        const profile = await Profile.findOne({ user: req.user.id});
        profile.education.unshift(newEdu); // push in newEXP to the array
        await profile.save();
